import { itemProps } from "../../components/Classificators/DateIndexer";

const dataDummyArray: itemProps[] = [
  {
    id: 1,
    date: "30/08/2024",
    type: "SP",
    ...
    content: [
      {
        bar: "I - ATOS ADMINISTRATIVOS E DECISÕES DO COLENDO CONSELHO SUPERIOR DA MAGISTRATURA",
        organ: "TRIBUNAL DE JUSTIÇA DO ESTADO DE SÃO PAULO - TJSP",
        department: "SEMA 1.2.1",
        acts: [
          {
            title: "SISPENSÃO DO EXPEDIENTE",
            species: "EXPEDIENTE",
            county: "ARTUR NOGUEIRA E MAIRINQUE ",
            ementa: `
            <p>Expediente &ndash; Suspens&atilde;o dos prazos dos processos f&iacute;sicos no per&iacute;odo</p>
          `,
            html: `
              <p>O Excelent&iacute;ssimo Senhor Desembargador Presidente do Tribunal de Justi&ccedil;a, em 30/08/2024, autorizou o que segue: <span style="color:#ffffff">-&ndash; Texto selecionado e originalmente divulgado pelo INR &ndash;</span></p>
              <p><strong>ARTUR NOGUEIRA - </strong>suspens&atilde;o do expediente presencial, a partir das 15h30, e dos prazos dos processos f&iacute;sicos no dia <strong>30 de agosto de 2024</strong>.</p>
              <p><strong><em>NOTA</em></strong><em>: Todas as atividades de magistrados, servidores, estagi&aacute;rios e colaboradores ser&atilde;o realizadas em trabalho remoto. As regulariza&ccedil;&otilde;es das frequ&ecirc;ncias dos servidores devem observar as orienta&ccedil;&otilde;es da SGP, conforme aviso no sistema de frequ&ecirc;ncia.</em></p>
              <p><strong>MAIRINQUE &ndash; (Setor das Execu&ccedil;&otilde;es Fiscais) - </strong>suspens&atilde;o dos prazos dos processos f&iacute;sicos no per&iacute;odo de <strong>02 a 16 de setembro de 2024.</strong> (Acervo INR &ndash; DJe de 02.09.2024 &ndash; SP)</p>
            `,
          },
        ],
      },
      {
        bar: "II - ATOS ADMINISTRATIVOS E DECISÕES DA EGRÉGIA CORREGEDORIA GERAL DA JUSTIÇA DO ESTADO DE SÃO PAULO",
        organ: "CORREGEDORIA GERAL DA JUSTIÇA DO ESTADO DE SÃO PAULO",
        department: "DICOGE 5.1",
