  ...
  return (
    <View style={styles.container}>
      ...
      <Text>
        ...
        de 2012, os{" "}
        <Text style={{ fontWeight: "bold" }}>Classificadores INR SP</Text> têm
        passado por uma série de mudanças, a fim de proporcionar aos{" "}
        <Text style={{ fontWeight: "bold" }}>
          Assinantes das Publicações INR
        </Text>{" "}
        uma experiência dinâmica e compatível com as exigências da Corregedoria
        Geral da Justiça. Com novos recursos e ferramentas, os{" "}
        <Text style={{ fontWeight: "bold" }}>Classificadores INR SP</Text>, cem
        por cento eletrônicos, levaram ao cotidiano de Notários e Registradores
        agilidade, facilidade e segurança.
      </Text>
      <Text>
        Assim, a começar de janeiro de 2013, além da divulgação por meio das
        edições diárias do{" "}
        <Text style={{ fontWeight: "bold" }}>Classificadores INR SP</Text>,
        estas passaram a ser substituídas, semanalmente, por versões atualizadas
        e com conteúdo acumulado desde o primeiro dia de publicações do ano
        vigente, até o final de cada exercício. São os chamados{" "}
        <Text style={{ fontWeight: "bold" }}>
          Classificadores Eletrônicos Acumulados
        </Text>
        , que possuem índice próprio, por assunto e com menção ao número do ato
        e à comarca de origem.
      </Text>
      <Text>
